...
module.exports = {
  ...
  // 禁止除法操作符显式的出现在正则表达式开始的位置[AUTO-FIX]
  "no-div-regex": 0,

  // 禁止 if 语句中 return 语句之后有 else 块[AUTO-FIX]
  "no-else-return": 0,
  ...
  // 禁止出现未使用过的变量
  "no-unused-vars": [1,  { "vars": "all", "args": "after-used", "ignoreRestSiblings": false, "argsIgnorePattern": "h" }],
  ...
  // 强制使用一致的缩进
  indent: [1, 2, { SwitchCase: 1, VariableDeclarator: "first" }],
